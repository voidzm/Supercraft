...
public class EssentialReducerRecipes {
	...
	private static void populateInputs() {
		...
		inputMappings.add(new EssentialReducerInputMap(new ItemStack(ItemHandler.silverFragment), EssentialAspect.AERONIC, EssentialAspect.TERRAEN));
		...
		inputMappings.add(new EssentialReducerInputMap(new ItemStack(ItemHandler.platinumIngot), EssentialAspect.FERRIC, EssentialAspect.TERRAEN));
		inputMappings.add(new EssentialReducerInputMap(new ItemStack(ItemHandler.lithiumIngot), EssentialAspect.FERRIC, EssentialAspect.TERRAEN));
		inputMappings.add(new EssentialReducerInputMap(new ItemStack(ItemHandler.metallicCobaltIngot), EssentialAspect.FERRIC, EssentialAspect.NETHEREAL));
		inputMappings.add(new EssentialReducerInputMap(new ItemStack(ItemHandler.cobaltDust), EssentialAspect.RADANTIS, EssentialAspect.NETHEREAL));
		inputMappings.add(new EssentialReducerInputMap(new ItemStack(ItemHandler.incendiumDust), EssentialAspect.INFERNAL, EssentialAspect.TERRAEN));
		inputMappings.add(new EssentialReducerInputMap(new ItemStack(ItemHandler.luxificenDust), EssentialAspect.LUXORUM, EssentialAspect.TERRAEN));
		inputMappings.add(new EssentialReducerInputMap(new ItemStack(ItemHandler.jadeCrystal), EssentialAspect.RADANTIS, EssentialAspect.TERRAEN));
		inputMappings.add(new EssentialReducerInputMap(new ItemStack(ItemHandler.voltasniaRod), EssentialAspect.RADANTIS, EssentialAspect.TERRAEN));
		inputMappings.add(new EssentialReducerInputMap(new ItemStack(ItemHandler.draconium), EssentialAspect.RADANTIS, EssentialAspect.DRACONIC));
	...
	private static void populateCatalysts() {
		...
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(BlockHandler.supercraftPlanks1), EssentialAspect.VERDEAL));
		...
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(BlockHandler.supercraftLog1), EssentialAspect.VERDEAL));
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(BlockHandler.supercraftLog2), EssentialAspect.VERDEAL));
		...
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(Block.obsidian), EssentialAspect.INFERNAL));
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(Block.ice), EssentialAspect.AQUAEOUS));
		...
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(Block.blockEmerald), EssentialAspect.RADANTIS));
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(Block.leaves), EssentialAspect.VIDALIS));
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(BlockHandler.supercraftLeaves1), EssentialAspect.VIDALIS));
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(BlockHandler.supercraftLeaves2), EssentialAspect.VIDALIS));
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(BlockHandler.radiantLeaves), EssentialAspect.VIDALIS));
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(Block.melon), EssentialAspect.VIDALIS));
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(Block.pumpkin), EssentialAspect.VIDALIS));
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(Block.cobblestoneMossy), EssentialAspect.MORTALIC));
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(Block.slowSand), EssentialAspect.MORTALIC));
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(Block.glowStone), EssentialAspect.LUXORUM));
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(Block.pumpkinLantern), EssentialAspect.LUXORUM));
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(Block.pumpkinLantern), EssentialAspect.LUXORUM));
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(Block.pumpkinLantern), EssentialAspect.LUXORUM));
		catalystMappings.add(new EssentialReducerCatalystMap(new ItemStack(BlockHandler.nightrock), EssentialAspect.TENEBRA));
	}
