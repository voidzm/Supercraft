...
public class ItemSupercraftShovel extends ItemSpade implements IRegisterable {

	private EnumToolMaterial material;
	private RegisterData rdata = new RegisterData();
	private String icon;
	
	public ItemSupercraftShovel(int par1, EnumToolMaterial par2EnumToolMaterial, String unlocalized, String localized, String iconPath) {
