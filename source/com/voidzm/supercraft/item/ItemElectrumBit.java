...
public class ItemElectrumBit extends Item {
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10) {
		...
		if(bID == BlockHandler.inscribedPalestone.blockID) {
			...
			par3World.setBlockWithNotify(par4, par5, par6, BlockHandler.blockOfGoldenwood.blockID);
			par3World.setBlockWithNotify(par4+1, par5, par6, BlockHandler.burnedPalestone.blockID);
			par3World.setBlockWithNotify(par4-1, par5, par6, BlockHandler.burnedPalestone.blockID);
			par3World.setBlockWithNotify(par4, par5, par6+1, BlockHandler.burnedPalestone.blockID);
			par3World.setBlockWithNotify(par4, par5, par6-1, BlockHandler.burnedPalestone.blockID);
