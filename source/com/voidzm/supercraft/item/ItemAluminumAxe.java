...
public class ItemAluminumAxe extends ItemAxe implements IRegisterable {
	...
	public ItemAluminumAxe(int par1) {
		...
		this.rdata.internalName = "axealuminum";
		this.rdata.externalName = "Aluminum Axe";
	}

	public void updateIcons(IconRegister par1IconRegister) {
		this.iconIndex = par1IconRegister.registerIcon("supercraft:axealuminum");
	}
