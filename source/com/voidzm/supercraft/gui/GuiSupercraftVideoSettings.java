...
public class GuiSupercraftVideoSettings extends GuiSupercraftScreen {
	...
	public GuiSupercraftVideoSettings(GuiSupercraftScreen par1GuiScreen, GameSettings par2GameSettings) {
		...
		if(par1GuiScreen instanceof GuiSupercraftOptions) { // If this is false, something went very very wrong.
