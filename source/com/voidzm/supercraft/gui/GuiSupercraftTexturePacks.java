...
public class GuiSupercraftTexturePacks extends GuiSupercraftScreen {

	private GuiSupercraftScreen parent;
	private int refreshTimer = -1;
	private String fileLocation = "";

	private GuiSupercraftTexturePackSlot texturePackSlot;

	private GameSettings settings;

	public boolean isIngame = false;

	public GuiSupercraftTexturePacks(GuiSupercraftScreen par1, GameSettings par2) {
		this.parent = par1;
		this.imageTick = par1.imageTick;
		if(par1 instanceof GuiSupercraftOptions) {
			this.isIngame = ((GuiSupercraftOptions)par1).isIngame;
		}
		this.settings = par2;
	}
	...
	public void initGui() {
		...
		this.texturePackSlot = new GuiSupercraftTexturePackSlot(this);
	...
	public static Minecraft fetchMinecraft(GuiSupercraftTexturePacks par1) {
		return par1.mc;
	}
	
	public static FontRenderer fetchFontRenderer(GuiSupercraftTexturePacks par1) {
