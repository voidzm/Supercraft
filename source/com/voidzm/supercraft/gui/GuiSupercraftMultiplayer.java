...
public class GuiSupercraftMultiplayer extends GuiSupercraftScreen {
	...
	private GuiSupercraftServerSlot slotServer;
	...
	public GuiSupercraftMultiplayer(GuiSupercraftScreen screen) {
		this.parent = screen;
	...
	public void initGui() {
		...
		if(!this.initialized) {
			...
			this.slotServer = new GuiSupercraftServerSlot(this);
		}
		else {
	...
	public static ServerList getInternetServerList(GuiSupercraftMultiplayer par0GuiMultiplayer) {
		return par0GuiMultiplayer.internetServerList;
	}

	public static List getListOfLanServers(GuiSupercraftMultiplayer par0GuiMultiplayer) {
		return par0GuiMultiplayer.localServers;
	}

	public static int getSelectedServer(GuiSupercraftMultiplayer par0GuiMultiplayer) {
		return par0GuiMultiplayer.selectedServer;
	}

	public static int getAndSetSelectedServer(GuiSupercraftMultiplayer par0GuiMultiplayer, int par1) {
		return par0GuiMultiplayer.selectedServer = par1;
	}

	public static GuiButtonTransparent getButtonSelect(GuiSupercraftMultiplayer par0GuiMultiplayer) {
		return par0GuiMultiplayer.buttonSelect;
	}

	public static GuiButtonTransparent getButtonEdit(GuiSupercraftMultiplayer par0GuiMultiplayer) {
		return par0GuiMultiplayer.buttonEdit;
	}

	public static GuiButtonTransparent getButtonDelete(GuiSupercraftMultiplayer par0GuiMultiplayer) {
		return par0GuiMultiplayer.buttonDelete;
	}

	public static void func_74008_b(GuiSupercraftMultiplayer par0GuiMultiplayer, int par1) {
		par0GuiMultiplayer.joinServer(par1);
	}

	public static int getTicksOpened(GuiSupercraftMultiplayer par0GuiMultiplayer) {
	...
	public static String getAndSetLagTooltip(GuiSupercraftMultiplayer par0GuiMultiplayer, String par1Str) {
