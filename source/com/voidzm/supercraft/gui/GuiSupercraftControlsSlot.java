...
public class GuiSupercraftControlsSlot extends GuiSupercraftSlot {

	private GuiSupercraftControls parent;
	private GameSettings settings;
	private String[] message;
	private int mx, my;
	private int selected = -1;
	
	public GuiSupercraftControlsSlot(GuiSupercraftControls controls, GameSettings gameSettings) {
