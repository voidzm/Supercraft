...
public abstract class GuiSupercraftSlot {
	...
	public GuiSupercraftSlot(Minecraft minecraft, int par1, int par2, int par3, int par4, int par5) {
		this.mc = minecraft;
		this.width = par1;
		this.height = par2;
		this.top = par3;
