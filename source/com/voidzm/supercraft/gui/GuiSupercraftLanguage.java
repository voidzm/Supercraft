...
public class GuiSupercraftLanguage extends GuiSupercraftScreen {

	private GuiSupercraftScreen parent;
	private int updateTimer = -1;
	private GuiSupercraftLanguageSlot languageSlot;
	private GameSettings settings;
	private GuiButtonTransparent doneButton;
	
	public boolean isIngame = false;

	public GuiSupercraftLanguage(GuiSupercraftScreen par1GuiScreen, GameSettings par2GameSettings) {
	...
	public void initGui() {
		...
		this.languageSlot = new GuiSupercraftLanguageSlot(this);
	...
	public static GameSettings getGameSettings(GuiSupercraftLanguage par0GuiLanguage) {
		return par0GuiLanguage.settings;
	}

	public static GuiButtonTransparent getDoneButton(GuiSupercraftLanguage par0GuiLanguage) {
