...
public class GuiSupercraftSnooper extends GuiSupercraftScreen {
	...
	private GuiSupercraftSnooperSlot snooperSlot;
	private GuiButtonTransparent buttonAllow;

	public boolean isIngame = false;

	public GuiSupercraftSnooper(GuiSupercraftScreen par1GuiScreen, GameSettings par2GameSettings) {
	...
	public void initGui() {
		...
		this.snooperSlot = new GuiSupercraftSnooperSlot(this);
	}
	...
	public static List fetchList1(GuiSupercraftSnooper par0GuiSnooper) {
		return par0GuiSnooper.list1;
	}

	public static List fetchList2(GuiSupercraftSnooper par0GuiSnooper) {
