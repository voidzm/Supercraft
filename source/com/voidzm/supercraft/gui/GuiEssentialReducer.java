...
public class GuiEssentialReducer extends GuiContainer {
	...
	private static final ResourceLocation ESSENTIALREDUCER_BACKGROUND = new ResourceLocation("supercraft:textures/gui/essentialreducer.png");
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
		...
		this.mc.renderEngine.func_110577_a(ESSENTIALREDUCER_BACKGROUND);
		int x = (width - xSize) / 2;
