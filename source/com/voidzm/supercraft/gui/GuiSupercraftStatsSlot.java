...
public abstract class GuiSupercraftStatsSlot extends GuiSupercraftSlot {
	...
	protected GuiSupercraftStatsSlot(GuiSupercraftStats par1GuiStats) {
	...
	protected void func_77222_a(int par1, int par2, Tessellator par3Tessellator) {
		...
		if(this.intG == 0) {
			GuiSupercraftStats.drawSprite(this.parent, par1 + 115 - 18, par2 + 1, 0, 0);
		}
		else {
			GuiSupercraftStats.drawSprite(this.parent, par1 + 115 - 18, par2 + 1, 0, 18);
		}
		if(this.intG == 1) {
			GuiSupercraftStats.drawSprite(this.parent, par1 + 165 - 18, par2 + 1, 0, 0);
		}
		else {
			GuiSupercraftStats.drawSprite(this.parent, par1 + 165 - 18, par2 + 1, 0, 18);
		}
		if(this.intG == 2) {
			GuiSupercraftStats.drawSprite(this.parent, par1 + 215 - 18, par2 + 1, 0, 0);
		}
		else {
			GuiSupercraftStats.drawSprite(this.parent, par1 + 215 - 18, par2 + 1, 0, 18);
		}
		if(this.intJ != -1) {
			short short1 = 79;
			byte b0 = 18;
			...
			GuiSupercraftStats.drawSprite(this.parent, par1 + short1, par2 + 1, b0, 0);
		}
	}
	...
	protected void func_77260_a(StatCrafting par1StatCrafting, int par2, int par3, boolean par4) {
		...
		if(par1StatCrafting != null) {
			s = par1StatCrafting.func_75968_a(GuiSupercraftStats.getStatsFileWriter(this.parent).writeStat(par1StatCrafting));
		...
		if(par2 >= this.top && par2 <= this.bottom) {
			...
			if(k >= 0) {
				...
				if(s.length() > 0) {
					...
					GuiSupercraftStats.drawGradientRect(this.parent, i1 - 3, j1 - 3, i1 + k1 + 3, j1 + 8 + 3, -1073741824, -1073741824);
	...
	protected void func_77259_a(StatCrafting par1StatCrafting, int par2, int par3) {
		if(par1StatCrafting != null) {
			...
			if(s.length() > 0) {
				...
				GuiSupercraftStats.drawGradientRect(this.parent, k - 3, l - 3, k + i1 + 3, l + 8 + 3, -1073741824, -1073741824);
