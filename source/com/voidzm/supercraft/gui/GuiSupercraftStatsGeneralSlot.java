...
public class GuiSupercraftStatsGeneralSlot extends GuiSupercraftSlot {

	private GuiSupercraftStats parent;
	
	public GuiSupercraftStatsGeneralSlot(GuiSupercraftStats stats) {
	...
	protected void drawSlot(int par1, int par2, int par3, int par4, Tessellator par5Tessellator) {
		...
		String s = statbase.func_75968_a(GuiSupercraftStats.getStatsFileWriter(this.parent).writeStat(statbase));
