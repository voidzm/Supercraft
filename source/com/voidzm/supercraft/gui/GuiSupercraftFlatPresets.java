...
public class GuiSupercraftFlatPresets extends GuiSupercraftScreen {
	...
	protected GuiSupercraftPresetsListSlot theFlatPresetsListSlot;
	private GuiButtonTransparent theButton;
	private GuiTextField theTextField;

	public GuiSupercraftFlatPresets(GuiSupercraftCreateFlatWorld parentScreen) {
	...
	public void initGui() {
		...
		this.theFlatPresetsListSlot = new GuiSupercraftPresetsListSlot(this);
