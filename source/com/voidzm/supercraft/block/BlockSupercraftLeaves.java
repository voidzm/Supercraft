...
public class BlockSupercraftLeaves extends BlockLeavesBase implements IShearable {

	public static final String[] leavesType = new String[] {"olive"};
	int[] adjacentTreeBlocks;
	private static int textureIndex = 16;
	
	public BlockSupercraftLeaves(int par1) {
		...
		this.setBlockName("supercraftLeaves");
    ...
    public int quantityDropped(Random par1Random) {
    	int rand = par1Random.nextInt(10);
        return rand == 0 ? 1 : 0;
    }
