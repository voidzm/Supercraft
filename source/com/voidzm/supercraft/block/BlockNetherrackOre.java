...
public class BlockNetherrackOre extends BlockSupercraft {
	...
	public BlockNetherrackOre(int par1, String icon, int dropItem) {
	...
	public BlockNetherrackOre(int par1, String icon) { 
		this(par1, icon, -1);
	}
	
	public BlockNetherrackOre setExtraDrop(int val) {
